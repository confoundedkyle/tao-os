...
export const CONNECTORS: Connector[] = [
  ...
  { name: "Findymail", category: "contacts", blurb: "Find and verify B2B emails and mobile numbers for candidates and clients.", provider: "findymail", live: true, auth: "apikey", apiKeyHint: "Copy your API key from Findymail at app.findymail.com → API.", metered: true, unit: "credits", defaultBudget: 50 },
  ...
  { name: "FullEnrich", category: "contacts", blurb: "Find verified emails and mobile numbers through a 15+ vendor waterfall.", provider: "fullenrich", live: true, auth: "apikey", apiKeyHint: "Copy your API key from FullEnrich at app.fullenrich.com → API.", metered: true, unit: "credits", defaultBudget: 50 },
  ...
  { name: "Hunter.io", category: "contacts", blurb: "Find and verify work email addresses instantly.", provider: "hunter", live: true, auth: "apikey", metered: true, unit: "credits", defaultBudget: 50 },
  ...
  { name: "LeadMagic", category: "contacts", blurb: "Find and verify B2B emails, paying only for valid results.", provider: "leadmagic", live: true, auth: "apikey", apiKeyHint: "Copy your API key from LeadMagic under Settings → API." },
  ...
  { name: "Lusha", category: "contacts", blurb: "B2B contact data to reach candidates and clients.", provider: "lusha", live: true, auth: "apikey" },
  ...
  { name: "MillionVerifier", category: "contacts", blurb: "Verify email deliverability in bulk, cheaply, before outreach.", provider: "millionverifier", live: true, auth: "apikey", apiKeyHint: "Copy your API key from MillionVerifier under your account → API." },
  { name: "NeverBounce", category: "contacts", blurb: "Verify email deliverability at scale before outreach.", provider: "neverbounce", live: true, auth: "apikey", apiKeyHint: "Copy your API key from NeverBounce under your account → Apps → Custom Integration (it starts with secret_)." },
  { name: "Nymeria", category: "contacts", blurb: "Enrich a person's emails and phone from a LinkedIn profile or email.", provider: "nymeria", live: true, auth: "apikey", apiKeyHint: "Copy your API key from Nymeria under Settings → API keys.", metered: true, unit: "credits", defaultBudget: 50 },
  ...
  { name: "Surfe", category: "contacts", blurb: "Enrich a contact's email and mobile number from a name or LinkedIn profile.", provider: "surfe", live: true, auth: "apikey", apiKeyHint: "Copy your API key from Surfe under Settings → API." },
  ...
  { name: "Tomba", category: "contacts", blurb: "Find and verify B2B emails from a name and company domain.", provider: "tomba", live: true, auth: "apikey", apiKeyPlaceholder: "key:secret", apiKeyHint: "Both are in Tomba under Settings → API (the key starts with ta_, the secret with ts_); paste them separated by a colon." },
  { name: "Trestle", category: "contacts", blurb: "Validate phone numbers — line type, carrier, and recent activity.", provider: "trestle", live: true, auth: "apikey", apiKeyHint: "Copy your API key from Trestle under your account → API." },
  { name: "Wiza", category: "contacts", blurb: "Reveal verified emails and mobile numbers from LinkedIn profiles.", provider: "wiza", live: true, auth: "apikey", apiKeyHint: "Create an API key in Wiza under Settings → API." },
  ...
  { name: "ZeroBounce", category: "contacts", blurb: "Verify email deliverability before adding addresses to outreach.", provider: "zerobounce", live: true, auth: "apikey", apiKeyHint: "Copy your API key from ZeroBounce under your account → API." },
